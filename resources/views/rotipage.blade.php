...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/roti.css') }}">
</head>
<body>
    <div class="navbar">
        <div class="nav-left">
    ...
    <div class="container">
        <div class="produk-container">
            ...
            <div class="produk-item">
                <img src="{{ asset('img/roti/cinnamon rools.jpg') }}" alt="Cake">
                <h3>Cinamon Rolls</h3>
                <h5>Rp 15.000</h5>
            </div>
            <div class="produk-item">
                <img src="{{ asset('img/roti/garlic bread.jpg') }}" alt="Tart">
                <h3>Garlic Bread</h3>
                <h5>Rp 17.000</h5>
            </div>
            <div class="produk-item">
                <img src="{{ asset('img/roti/pizza bombs.jpg') }}" alt="Pastry">
                <h3>Pizza Bombs</h3>
                <h5>Rp 12.000</h5>
            </div>
            <div class="produk-item">
                <img src="{{ asset('img/roti/pizza mini.jpg') }}" alt="Kue Kering">
                <h3>Pizza Mini</h3>
                <h5>Rp 15.000</h5>
            </div>
            <div class="produk-item">
                <img src="{{ asset('img/roti/roti asin.jpg') }}" alt="Kue Basah">
                <h3>Roti Asin</h3>
                <h5>Rp 13.000</h5>
            </div>
        </div>
